    ...
    <>
      ...
      {type === "outlined" && (
        <button
          type="button"
          onClick={() => onClick()}
          className={cn("hover:text-white border font-medium rounded-lg text-center", {
            "text-sm px-5 py-2.5": size === "lg",
            "text-sm px-2 py-1": size === "sm",
            "text-blue-700 border-blue-700 hover:bg-blue-800 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800": variant === "primary",
            "text-red-700 border-red-700 hover:bg-red-800 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800": variant === "danger"
          })}
        >
          {children}
        </button>
